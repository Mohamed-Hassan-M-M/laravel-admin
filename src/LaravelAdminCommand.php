...
namespace Acmetemplate\LaravelAdmin;
...
class LaravelAdminCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->call('vendor:publish', ['--provider' => 'Acmetemplate\CrudGenerator\CrudGeneratorServiceProvider', '--force' => true]);
        $this->call('vendor:publish', ['--provider' => 'Acmetemplate\LaravelAdmin\LaravelAdminServiceProvider', '--force' => true]);
...
Route::get('admin/generator', ['uses' => '\Acmetemplate\LaravelAdmin\Controllers\ProcessController@getGenerator']);
Route::post('admin/generator', ['uses' => '\Acmetemplate\LaravelAdmin\Controllers\ProcessController@postGenerator']);
