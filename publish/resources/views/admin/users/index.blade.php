            ...
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> @lang('users.users')
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right text-md-right col-md-6 col-12">
                    <div class="btn-group">
                        ...
                        <a class="btn btn-jinja rounded  m-1" href="{{ url('/admin/users/create') }}" > <span class="display-inline-block">@lang('general.add')</span> <i class="la la-lg la-plus"></i></a>
                        {{--                        @endif--}}
                        ...
                        @endphp
                        <form method="post" action="{{ route($routeGroup . 'users.bulk_delete') }}" style="display: inline-block;">
                            @csrf
                            @method('delete')
