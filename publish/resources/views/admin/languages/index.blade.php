            ...
            <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> @lang('languages.languages')
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="content-header-right text-md-right col-md-6 col-12">
                    <div class="btn-group">
                        ...
                        <a class="btn btn-jinja rounded  m-1" href="{{ url('admin/languages/create') }}" > <span class="display-inline-block">@lang('general.add')</span> <i class="la la-lg la-plus"></i></a>
                        @php
                           $routeGroup = 'admin/';
                           $routeGroup = str_replace('/', '.', $routeGroup);
                        @endphp
                        <form method="post" action="{{ route($routeGroup . 'languages.bulk_delete') }}" style="display: inline-block;">
                            @csrf
                            @method('delete')
                            <input type="hidden" name="record_ids" id="record-ids">
                            <button class="btn btn-jinja rounded  mb-1 mt-1 white buttonAnimation" type="submit" id="bulk-delete" data-animation="pulse" > <span class="display-inline-block">@lang('general.bulk_delete')</span> <i class="la la-lg la-trash"></i></button>
                        </form>
