                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                @endphp
                                <li class="breadcrumb-item"><a href="{{route($routeGroup . 'settings.index')}}">@lang('settings.settings')</a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        <form method="POST" class="form form-horizontal" action="{{route($routeGroup . 'settings.update', $setting->id)}}"  enctype="multipart/form-data">
                                            @method('PUT')
                                            @csrf
