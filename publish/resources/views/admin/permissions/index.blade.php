            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-right col-md-6 col-12">
                    <div class="btn-group">
                        ...
                        <a class="btn btn-jinja rounded  m-1" href="{{ url('/admin/permissions/create') }}" > <span class="display-inline-block">@lang('general.add')</span> <i class="la la-lg la-plus"></i></a>
                        {{--                        @endif--}}
